...
import glob
import parquet
parquet_files = glob.glob("/user/alexeys/kMeansLabels_20/*parquet")
...
finput = open("/scratch/network/alexeys/bills/lexs/bills_20.json","r")
...
#FIXME I think we only need label for metadata so remove these parts
#data first
...
#metadata
finput_meta = open("/scratch/network/alexeys/bills/lexs/bills_metadata_20.json","r")
...
foutput_meta = open("/scratch/network/alexeys/bills/lexs/labeled_bills_metadata_20.json","wa")
